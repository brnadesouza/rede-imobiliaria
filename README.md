...
Este projeto tem como objetivo implementar progressivamente e de forma didática uma aplicação web inspirada em site imobiliário (compra e venda de imóveis).
...
https://www.figma.com/design/41jyYS0CEnHoBJ4CTC8Ads/Design-System---Rede-Imobili%C3%A1ria?node-id=0-1&node-type=canvas&t=Aky3xLoUMZlwNRkx-0

## Design System: 
Link para o PDF

## Site em Produção - GitHub Pages
https://github.com/brnadesouza/rede-imobiliaria
